"""scripts/_lib/cli.py — shared scaffolding for the `jarvis-*` CLIs.
...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("jarvis-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/jarvis-foo`
...
VERSION = "0.1.0"  # bumped centrally; every jarvis-* CLI reports this
