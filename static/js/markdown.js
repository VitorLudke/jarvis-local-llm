...
function initMermaid() {
  if (!window.mermaid || window.__jarvisMermaidReady) return;
  window.mermaid.initialize({ startOnLoad: false, theme: 'dark', securityLevel: 'loose' });
  window.__jarvisMermaidReady = true;
}
window.jarvisInitMermaid = initMermaid;
initMermaid();
...
const THINK_EXPANDED_KEY = 'jarvis-thinking-expanded';
