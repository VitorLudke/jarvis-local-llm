...
def _load_dispatcher():
    path = Path(__file__).resolve().parent.parent / "scripts" / "jarvis"
    loader = importlib.machinery.SourceFileLoader("jarvis_dispatcher_under_test", str(path))
